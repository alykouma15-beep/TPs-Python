...
def thread_ecoute():
    ...
    while True:
        ...
        print(recu:=c.recv(1024).decode('ascii'))#Reception du message JSON
        recu=json.loads(recu)#objet json parsé en dictionnaire python
        print(recu["nom"]) #valeur de la clé "nom"
        print(recu["date_connexion"]) #valeur de la clé "date_connexion"
        print(recu["lieu"]) #valeur de la clé "lieu"
